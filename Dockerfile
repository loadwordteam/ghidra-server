...
# ghidra-server
FROM openjdk:11-jdk AS buildstage

ENV GHIDRA_CERT_PASSWORD ''
ENV GHIDRA_LISTEN_IP 0.0.0.0
...
ARG ghidra_cert_path="${ghidra_install_path}/cert"

ENV GHIDRA_HOME $ghidra_install_path
ENV GHIDRA_REPO_DIR $ghidra_repo_path
ENV GHIDRA_CERT_PATH $ghidra_cert_path
